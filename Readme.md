# Project Name : Beats Landing Page ![Tech Stack Used](https://img.shields.io/badge/Technologies-HTML%20%26%20CSS-orange)
...
- In this project, I have built a **Beats Landing Page** from the scratch using core `HTML` & `CSS`.
...
https://beats-landing-page-alpha.vercel.app/ 
...
> [![Live Link](https://img.shields.io/badge/DEPLOYED-LINK-green)](https://beats-landing-page-alpha.vercel.app/)
